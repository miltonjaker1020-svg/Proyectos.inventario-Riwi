...
def agregar_producto():
    ...
    #Validacion de que el producto sea un string y tmabien que no este vacio
        ...
        try: 
            ...
            confirmar=input("desea agregar otro producto? (si/no): ").lower()  # Preguntamos si quiere agregar otro producto
            ...
            if confirmar=="no":  # Si pone no cerramos el siclo con un confirmar false
                confirmar=False
                
            elif confirmar=="si": # Si pone si inicia otra iteracion con un confirmar true
                confirmar=True
